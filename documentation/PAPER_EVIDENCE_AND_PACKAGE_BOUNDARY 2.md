...
Generated: 2026-05-17 08:40:20 AEST
...
Retain source attribution to the Scripps CO2 Program for the Mauna Loa data. The included paper PDF is a reference copy for review; publisher terms apply to redistribution. Repository-level license text for the author-created code should be set at upload time.
